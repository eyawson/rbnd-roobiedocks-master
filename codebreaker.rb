...
# Every time I put all the delete code in one line it didnt work,help
code.delete! 'Q'
code.delete! '?'
code.delete! ','
code.downcase!
code.capitalize!
# It took me a long time to figure this last reverse. Glad you talked about Matz
code.reverse!
#I'm proud of this. It probably might not be pretty but it's a step
puts code
